...
@endphp
    ...
    <div class="container-menu-desktop">
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <!-- Logo desktop -->
                <a href="#" class="logo">
                    <img src="{{asset('public/template/images/icons/logo-01.png')}}" alt="IMG-LOGO">
                </a>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="index.html"><img src="{{asset('public/template/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
        </div>
